<section class="section-slider height-v">
    <div id="index12" class="owl-carousel  owl-theme">
        @foreach ($banners as $item)
            <div class="item">
            <img alt="Third slide" src="uploads/{{$item->Image}}" class="img-responsive" >
            ...
            <div class="row">
                <div id="rooms" class="owl-carousel owl-theme">
                    <div class="item ">
                        ...
                        <a href="/room/detail/{{$item->id}}"><div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 ">
                            <div class="wrap-box">
                                <div class="box-img">
                                    <img src="/uploads/{{$item->Image}}" class="img-responsive" style="width: 370px; height: 255px;" alt="PLuxury Room" title="Luxury Room">
                                </div>
                                <div class="rooms-content">
                                    <h4 class="sky-h4">{{$item->Name}}</h4>
                                    <p class="price">${{$item->PricePerNight}} / Per Night</p>
                                </div>
                            </div>
                        </div></a>
                        @endforeach
